...
public class AutoScheduling {
    ...
    private final Map<HopeTime, List<Schedule>> schedules = new EnumMap<>(HopeTime.class);
    private double fixedM3Ratio;
    private Map<Integer, Manager> managerNodes;
    
    public ArrayList<ResultScheduling> runAlgorithm(List<Integer> userCodes, List<Integer> totalAssignTimes,
            List<List<Integer>> startTimesOfHopeTime) {
    ...
    private void putCardsByHopeTime(Map<HopeTime, List<EstimatedNumOfCardsPerHour>> cardsByHopeTime,
            EstimatedNumOfCardsPerHour card) {
    ...
    private Map<Integer, Manager> makeManagerNodes(List<Integer> userCodes, List<Integer> totalAssignTimes,
            List<List<Integer>> startTimesOfHopeTime) {
    ...
    private void addSchedules(List<EstimatedNumOfCardsPerHour> cards, double totalCardValueAvg,
